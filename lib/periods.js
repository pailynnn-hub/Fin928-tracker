...
export const ACTIVITY_FIELDS = [
  ...
  { key: 'after_sales_visits', label: 'เยี่ยมลูกค้าหลังขาย/เคลมประกัน' },
  { key: 'crm_activities', label: 'ทำ CRM (บริการเหนือกว่า)' },
  { key: 'referral_requests', label: 'ขอต่อรายชื่อ (Referral)' },
]
